      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 col-sm-6">
            <?php printf( __( 'Powered by','blogim' )); ?> <a href="<?php echo esc_url('https://indigothemes.com/products/free-responsive-wordpress-blog-theme-blogim/'); ?>"><?php printf( __( 'BlogIM WordPress Theme','blogim' )); ?></a>                            
          </div><!-- end of col -->
